...
export interface ReconciliationDifferenceReadingSummary {
  ...
  recentPersistenceContext:
    ...
    | "perda_de_forca"
    | "persistencia_neutra";
  recentPersistenceContextLabel: string;
  recentPersistenceContextReason: string;
  ...
  recentRecoveryContextLabel: string;
  recentRecoveryContextReason: string;
}
...
export interface ContractReconciliationSummary {
  ...
  recurrenceTemporalState:
    | "sem_base_temporal_suficiente"
    | "recorrencia_ativa"
    | "recorrencia_em_reducao"
    | "historico_superado";
  recurrenceTemporalStateLabel: string;
  recurrenceTemporalStateReason: string;
  ...
  recentPersistenceState:
    | "persistencia_forte"
    | "persistencia_moderada"
    | "perda_de_forca"
    | "persistencia_neutra";
  recentPersistenceStateLabel: string;
  recentPersistenceStateReason: string;
  recentRecoveryState:
    | "recuperacao_perceptivel"
    | "recuperacao_incipiente"
    | "reducao_sem_recuperacao_clara"
    | "sem_sinal_recente_de_recuperacao";
  recentRecoveryStateLabel: string;
  recentRecoveryStateReason: string;
